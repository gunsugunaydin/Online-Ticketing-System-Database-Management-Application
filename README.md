...
2. *Installation Steps:*
   ...
   *2.1. Clone the Project & Create Database and Tables:*
    ...
    # Execute the SQL script `createdb.sql` to create the necessary database schema and tables. 
    # This script initializes the structure required for the Online Ticketing System.
